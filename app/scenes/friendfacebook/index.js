...
class FriendFacebookScreen extends Component{
        ...
        return (
            <Container style={styles.container}>
                <Header style={styles.header}>
                    ...
                    <Body>
                        <Title style={styles.title}>FACEBOOK</Title>
                    </Body>
                ...
                <View style={styles.syncContainer}>
                    ...
                    <Switch tintColor="#2E4686" value={true} onTintColor="#2E4686"/>
                </View>
                <Content>
                    {this.state.step == 1?
                    ...
                    <List>
                        ...
                        <ListItem avatar style={styles.listItem}>
                            ...
                            <Right style={styles.itemRight}>
                                <Switch tintColor="#2E4686" value={false} onTintColor="#2E4686"/>
                            </Right>
                        </ListItem>
                        <ListItem avatar style={styles.listItem1}>
                            <Left>
...
export default connect()(FriendFacebookScreen);